...
if __name__ == "__main__":
    ...
    while True:
    # ask whose turn based on b.turn
        raw = input(f"{b.turn}'s move: (upper left, upper center, upper right, middle left, center, middle right, lower left, lower center, lower right)")
